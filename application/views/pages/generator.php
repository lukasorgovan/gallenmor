<?php $this->load->view('layout/index/header', array('cssPath' => '/assets/css/generator.css')); ?>
...
<?php $this->load->view('layout/index/footer', array('scriptPath' => array('/assets/js/generator.js'))); ?>