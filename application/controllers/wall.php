...
class Wall extends LoggedController {
    ...
    public function create() {
        ...
        if (!$message || $message == '') {
            ...
            if ($this->wall_post->create($message, $section)) {
    ...
    public function delete() {
        ...
        redirect('wall/' . $section_name); // redirect to the clubhouse
    }
    ...
    public function update() {
        ...
        if (!$this->wall_post->is_authorized_to_manage($id)) {
            ...
            if ($this->wall_post->update($id, $message)) {
    ...
    public function edit($id) {
        if (!$this->wall_post->is_authorized_to_manage($id)) {
            ...
            $data['post'] = $this->wall_post->getPost($id);
        }
