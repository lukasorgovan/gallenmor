window.systemMessages =  {
	register: {
		username: 'Používateľské meno môže mať maximálne 20 znakov a musí obsahovať iba písmená, prípadne môže mať 2 čísla na konci. Príklady: Elza, Maros22, FenixBlack,...',
		date: 'Dátum narodenia zadaj v tvare rok-mesiac-deň. Príklad: 1991-05-23',
		password: 'Heslo musí mať aspon 6 znakov a môže obsahovať iba písmená bez diakritiky a číslice',
		passwordCheck: 'Heslá sa nezhodujú. Pre istotu skontroluj, či si si nezapol CAPS-LOCK a napíš obidve heslá ešte raz.',
		email: 'Prepáč, ale podľa nášho systému toto nie je platná emailová adresa.',
		race: 'Pokúšaš sa hackovať našu stránku? Smola. Tvoja IP bola zaznamenaná.',
